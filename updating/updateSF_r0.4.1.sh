...
xzcat /home/root/pueo_surf6_v0r2p3.bit.xz > /lib/firmware/pueo_surf6_v0r2p3.bit
mv /home/root/pueo_surf6_v0r2p3.bit.xz /mnt/bitstreams/0/
# update the next pointers
rm /lib/firmware/next
ln -s /lib/firmware/pueo_surf6_v0r2p3.bit /lib/firmware/next
rm /tmp/pueo/next
