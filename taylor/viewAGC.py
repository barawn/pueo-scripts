...
for i in range(8): #loop over channels
    ...
    print(f"Slot 1 Ch {i:2} Var:{sqr:11.3e} GT:{gt:11.3e} LT:{lt:11.3e} Scale:{scale:11d} Offset:{offset:11d}")
print("")
print("")
surf3=PueoSURF((tio,2),'TURFIO')
for i in range(8): #loop over channels
    ...
    print(f"Slot 2 Ch {i:2} Var:{sqr:11.3e} GT:{gt:11.3e} LT:{lt:11.3e} Scale:{scale:11d} Offset:{offset:11d}")
...
for i in range(8): #loop over channels
    ...
    scale=surf3.levelone.read(0x4010+0x400*i)
    offset=surf3.levelone.read(0x4014+0x400*i)
    print(f"Slot 5 Ch {i:2} Var:{sqr:11.3e} GT:{gt:11.3e} LT:{lt:11.3e} Scale:{scale:11d} Offset:{offset:11d}")
