...
parser.add_argument("--eightThreshold", type=int, default=-1)
parser.add_argument("--sixThreshold", type=int, default=-1)
...
for slot in slotList: 
    ...
    for i in range(args.nbeams): 
        ...
        if(i<=34):
            surf.levelone.write(0x800 + i*4, args.eightThreshold) #
        if(i>34):
            surf.levelone.write(0x800 + i*4, args.sixThreshold) #
        #if not args.freeze: 
